 ...
 */
$title = ( is_search() ? sprintf( __( 'Your search for %s did not match any entries.', 'responsive' ), get_search_query() ) : __( '404 &#8212; Page not Found', 'responsive' ) );
?>

	<h1><?php echo $title; ?></h1>

	<p><?php _e( 'The page you are looking for is unavailable.', 'responsive' ); ?></p>
